...
import { X, Banknote, CreditCard, Building2, Star, Split } from 'lucide-react'
...
const SINGLE_METHODS: { value: SingleMethod; label: string; icon: React.ElementType }[] = [
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {SINGLE_METHODS.map(m => <option key={m.value} value={m.value}>{m.label}</option>)}
                    </select>
                    <input
                      type="number"
                      value={split1Amount}
